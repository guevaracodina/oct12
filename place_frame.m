function No_of_A_lines=place_frame(vol,structure_extracted,doppler_extracted,...
...
% keyboard
    vol.Structure(Index{corner})=linear_structure...
        .*weight{corner}+vol.Structure(Index{corner});
    
    vol.Doppler(Index{corner})=linear_doppler1...
        .*weight{corner}+vol.Doppler(Index{corner});
